...
function About() {
  ...
  return (
    <div className="container mx-auto mt-5 p-4" role="main">
      <div className="flex flex-wrap m-16">
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0 md:pr-6 flex flex-col">
          ...
          <h4 className="text-lg mb-4" tabIndex="0">
            {t("exquisiteDiningSubtitle")}
          </h4>
          <p className="mt-1 text-justify" tabIndex="0">
      ...
      <div className="m-16">
        <h3 className="text-left mb-6" tabIndex="0">
          {t("OurCommitments")}
        </h3>
        <div className="flex flex-wrap -mx-3">
          ...
          >
            <MdOutlineEco
              ...
              id="eco-friendly"
            />
            <h4 className="mt-2" tabIndex="0">
              {t("EcofriendlyPractices")}
            </h4>
            <p className="mt-1 max-w-lg text-justify" tabIndex="0">
          ...
          <div
            className="w-full md:w-1/2 px-3 mb-6"
            role="region"
            aria-labelledby="unmatched-quality"
          >
            <AiOutlineStar
      ...
      <div className="m-16">
        <h3 tabIndex="0">{t("ComeVisitUs")}</h3>
        <iframe
      ...
      <div className="flex justify-center items-center mb-8">
        <Link to="/reserve">
          <button
            className="bg-dark-green hover:bg-light-green text-white py-3 px-32 rounded-lg transition duration-200 ease-in-out"
